...
![AppService Deployment Task](../img/visitreports-deployment-task.png)
...
![App Service Deployment Task](../img/textanalytics-deployment-task.png)
...
![ApplicationMap](../img/applicationinsights-appmap.png)
...
![Performance Filter](../img/aiperf-filter.png)

Check out some details about the SCM API operations:

![Operations](../img/ai-operation-details.png)

Drill into a sample and see the "End to end transaction":

![Sample](../img/operation-drill.png)
