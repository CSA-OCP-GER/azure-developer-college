+++
title = "Integrate Azure AD into the SCM Contacts API"
chapter = false
weight = 30
+++
...
![401 Swagger](../img/401-swagger-contacts.png)
...
![TokenEchoServer Reply Url](../img/tokenechoserver-redirecturl.png)
...
![Permission Request](../img/permission-request.png?height=400px)
...
![Swagger Authorize](../img/swagger-authorize.png?height=400px)
